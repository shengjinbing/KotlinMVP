package com.example.administrator.kotlinmvp.ui.adapter
...
import com.example.administrator.kotlinmvp.durationFormat
import com.example.administrator.kotlinmvp.glide.GlideApp
 ...
 */
class VideoDetailAdapter(mContent: Context, data: ArrayList<HomeBean.Issue.Item>)
    : CommonAdapter<HomeBean.Issue.Item>(mContent, data, object : MultipleType<HomeBean.Issue.Item> {
...
})
{
     ...
     */
    var mOnItemClickRelatedVideo : ((item: HomeBean.Issue.Item) -> Unit)? = null;

    fun setOnItemDetailClick(mOnItemClickRelatedVideo : (item: HomeBean.Issue.Item) -> Unit){
        this.mOnItemClickRelatedVideo = mOnItemClickRelatedVideo
    }
